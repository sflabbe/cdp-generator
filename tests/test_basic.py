...
def test_individual_functions():
    ...
    print(
        f"✓ Strength properties: f_ck={strength_props['f_ck']:.2f} MPa, f_ctm={strength_props['f_ctm']:.2f} MPa"
    )
    ...
    print(
        f"✓ Elastic modulus: E_ci={elastic_props['E_ci']:.2f} MPa, E_c={elastic_props['E_c']:.2f} MPa"
    )
